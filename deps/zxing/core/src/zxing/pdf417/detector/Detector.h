...
private:
  ...
  static const size_t SIZEOF_START_PATTERN;
  static const size_t SIZEOF_START_PATTERN_REVERSE;
  static const size_t SIZEOF_STOP_PATTERN;
  static const size_t SIZEOF_STOP_PATTERN_REVERSE;
  static const size_t COUNT_VERTICES;
